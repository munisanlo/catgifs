...
// new View().$mount('#catgifs')

// Esta es la veersion del punto 2 del tutorial.
// We import the necessary Nextcloud modules
// Parece que no hace falta Vue aqui?
// Pero como hace mounting del componente App.vue?
// View().$mount('#catgifs')????
// more changes
